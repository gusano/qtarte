...
# Version : 0.2
#
# Graphical user's interface for Arte+7Recorder version Qt
#
# arte+7recorder : https://launchpad.net/~arte+7recorder
# qtarte : https://code.launchpad.net/~arte+7recorder/+junk/qtarte
#
# Copyright: 2010 Vincent Vande Vyvre
# Licence: LGPL3
#
#
